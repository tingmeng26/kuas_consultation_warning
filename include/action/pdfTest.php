...
List example:
<ol>
	<li><img src="./modules/tcpdf/lib/images/logo_example.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
	<li><b>bold text</b></li>
...
<img src="./modules/tcpdf/lib/images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="./modules/tcpdf/lib/images/tiger.ai" alt="test alt attribute" width="100" height="100" border="0" /><img src="./modules/tcpdf/lib/images/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
// create some HTML content
$subtable = '<table border="1" cellspacing="6" cellpadding="4"><tr><td style="width:50px;height:auto">aaaaaaaaaaaaaaa</td><td>b</td></tr><tr><td>c</td><td>d</td></tr></table>';
...
<tr><td><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" /></td></tr>
<tr style="text-align:left;"><td><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
<tr style="text-align:center;"><td><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
<tr style="text-align:right;"><td><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
<tr><td style="text-align:left;"><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
<tr><td style="text-align:center;"><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
<tr><td style="text-align:right;"><img src="./modules/tcpdf/lib/images/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
</table>';
...
require('./modules/tcpdf/lib/htmlcolors.php');
...
<ul style="font-size:14pt;list-style-type:img|png|4|4|./modules/tcpdf/lib/images/logo_example.png">
